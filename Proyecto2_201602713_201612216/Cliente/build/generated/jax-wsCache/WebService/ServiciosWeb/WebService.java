 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://ServiciosWeb/", wsdlLocation = "http://localhost:8080/Servidor/WebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICE_QNAME = new QName("http://ServiciosWeb/", "WebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Servidor/WebService?WSDL");
     ...
     * 
     * @return
     *     returns ServiciosWeb1
     */
    @WebEndpoint(name = "ServiciosWeb1Port")
    public ServiciosWeb1 getServiciosWeb1Port() {
        return super.getPort(new QName("http://ServiciosWeb/", "ServiciosWeb1Port"), ServiciosWeb1.class);
    }
     ...
     */
    @WebEndpoint(name = "ServiciosWeb1Port")
    public ServiciosWeb1 getServiciosWeb1Port(WebServiceFeature... features) {
        return super.getPort(new QName("http://ServiciosWeb/", "ServiciosWeb1Port"), ServiciosWeb1.class, features);
    }
