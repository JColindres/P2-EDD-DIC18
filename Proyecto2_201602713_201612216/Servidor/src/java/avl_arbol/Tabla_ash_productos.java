...
public class Tabla_ash_productos {
    ...
    public  void funcionHash(String codigo,String nombre,String marca,double precio,String ruta){
        ...
        int k=0;
        int clave= llave;boolean hacer=true;
    ...
    public  void graficar(){
        ...
        String archivo = "C:\\Users\\Toshiba\\Documents\\NetBeansProjects\\AVL_arbol\\hash.dot";
        try {
        ...
        try {
            String cmd = "dot -Tpng " + "C:\\Users\\Toshiba\\Documents\\NetBeansProjects\\AVL_arbol\\hash" + ".dot -o " +"C:\\Users\\Toshiba\\Documents\\NetBeansProjects\\AVL_arbol\\hash" + ".png"; //Comando de apagado en linux
