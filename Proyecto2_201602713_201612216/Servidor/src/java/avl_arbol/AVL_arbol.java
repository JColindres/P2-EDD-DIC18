        ...
        do {
            ...
            switch (op) {
                case 1:
                    ...
                    ab.insertar(valor);
                    valor = new info(32, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(3, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(53, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(43, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(44, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(57, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(67, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(7, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(45, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(34, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(23, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(12, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(56, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(73, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(65, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(49, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(85, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(89, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(64, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(54, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(75, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(77, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(49, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(90, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(33, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(50, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(58, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(59, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(60, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(56, "05/01/19", 100);
                    ab.insertar(valor);
                    valor = new info(73, "05/01/19", 100);
